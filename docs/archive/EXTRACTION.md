# Extraction observations — September 10–11, 2026

Historical report: results and approval outcomes below describe those checks only. See the [current extraction guide](../EXTRACTION.md) for supported behavior and the [MVP plan](../MVP_PLAN.md#remaining-work) for remaining release checks.
